...
API_INTERFACE void CALLTYPE addRenderTarget(Renderer *pRenderer,
...
#endif
API_INTERFACE void CALLTYPE addShaderBinary(Renderer *pRenderer,
...
// pipeline functions
API_INTERFACE void CALLTYPE addRootSignature(Renderer *pRenderer,
...
API_INTERFACE void CALLTYPE addPipeline(Renderer *pRenderer,
...
API_INTERFACE void CALLTYPE addPipeline(Renderer *pRenderer,
                                        ...
                                        Pipeline **pp_pipeline);
RENDERER_DEPRECATED("Use addPipeline(Renderer* , const PipelineDesc* , Pipeline** ) instead")
API_INTERFACE void CALLTYPE addComputePipeline(Renderer *pRenderer,
...
API_INTERFACE void CALLTYPE addRasterizerState(Renderer *pRenderer,
...
API_INTERFACE void CALLTYPE cmdBindRenderTargets(Cmd *p_cmd,
...
API_INTERFACE void CALLTYPE cmdSetViewport(Cmd *p_cmd,
                                           float x,
                                           float y,
                                           float width,
                                           float height,
...
API_INTERFACE void CALLTYPE cmdBindDescriptors(Cmd *pCmd,
                                               RootSignature *pRootSignature,
                                               uint32_t numDescriptors,
                                               DescriptorData *pDescParams);
API_INTERFACE void CALLTYPE cmdBindIndexBuffer(Cmd *p_cmd, Buffer *p_buffer, uint64_t offset);
API_INTERFACE void CALLTYPE cmdBindVertexBuffer(Cmd *p_cmd,
                                                uint32_t buffer_count,
                                                Buffer **pp_buffers,
                                                uint64_t *pOffsets);
API_INTERFACE void CALLTYPE cmdDraw(Cmd *p_cmd, uint32_t vertex_count, uint32_t first_vertex);
API_INTERFACE void CALLTYPE cmdDrawInstanced(Cmd *pCmd,
                                             uint32_t vertexCount,
                                             uint32_t firstVertex,
                                             uint32_t instanceCount,
                                             uint32_t firstInstance);
API_INTERFACE void CALLTYPE cmdDrawIndexed(Cmd *p_cmd,
                                           uint32_t index_count,
                                           uint32_t first_index,
                                           uint32_t first_vertex);
API_INTERFACE void CALLTYPE cmdDrawIndexedInstanced(Cmd *pCmd,
                                                    uint32_t indexCount,
                                                    uint32_t firstIndex,
                                                    uint32_t instanceCount,
                                                    uint32_t firstVertex,
                                                    uint32_t firstInstance);
API_INTERFACE void CALLTYPE cmdDispatch(Cmd *p_cmd,
                                        uint32_t group_count_x,
                                        uint32_t group_count_y,
                                        uint32_t group_count_z);

// Transition Commands
API_INTERFACE void CALLTYPE cmdResourceBarrier(Cmd *p_cmd,
                                               uint32_t buffer_barrier_count,
                                               BufferBarrier *p_buffer_barriers,
                                               uint32_t texture_barrier_count,
                                               TextureBarrier *p_texture_barriers,
                                               bool batch);
API_INTERFACE void CALLTYPE cmdSynchronizeResources(Cmd *p_cmd,
                                                    uint32_t buffer_count,
                                                    Buffer **p_buffers,
...
API_INTERFACE void CALLTYPE acquireNextImage(Renderer *pRenderer,
                                             SwapChain *p_swap_chain,
                                             Semaphore *p_signal_semaphore,
                                             Fence *p_fence,
                                             uint32_t *p_image_index);
API_INTERFACE void CALLTYPE queueSubmit(Queue *p_queue,
                                        uint32_t cmd_count,
                                        Cmd **pp_cmds,
                                        Fence *pFence,
...
API_INTERFACE void CALLTYPE queuePresent(Queue *p_queue,
                                         SwapChain *p_swap_chain,
...
API_INTERFACE void CALLTYPE addIndirectCommandSignature(Renderer *pRenderer,
...
API_INTERFACE void CALLTYPE cmdExecuteIndirect(Cmd *pCmd,
...
API_INTERFACE void CALLTYPE cmdResolveQuery(Cmd *pCmd,
