...
class Image {
 public:
  ...
  unsigned char *
  Create(const ImageFormat::Enum fmt,
         const int w,
         const int h,
         const int d,
  ...
  uint32_t GetArraySliceSize(const uint32_t mipMapLevel = 0, ImageFormat::Enum srcFormat = ImageFormat::NONE) const;
  ...
  uint32_t GetMipMappedSize(
      ...
      ImageFormat::Enum srcFormat = ImageFormat::NONE) const;
...
static inline uint32_t calculateImageFormatStride(ImageFormat::Enum format) {
  ...
  switch (format) {
    // 1 channel
    case ImageFormat::R8: result = 1;
      break;
    case ImageFormat::R16: result = 2;
      break;
    case ImageFormat::R16F: result = 2;
      break;
    case ImageFormat::R32UI: result = 4;
      break;
    case ImageFormat::R32F: result = 4;
      break;
      // 2 channel
    case ImageFormat::RG8: result = 2;
      break;
    case ImageFormat::RG16: result = 4;
      break;
    case ImageFormat::RG16F: result = 4;
      break;
    case ImageFormat::RG32UI: result = 8;
      break;
    case ImageFormat::RG32F: result = 8;
      break;
      // 3 channel
    case ImageFormat::RGB8: result = 3;
      break;
    case ImageFormat::RGB16: result = 6;
      break;
    case ImageFormat::RGB16F: result = 6;
      break;
    case ImageFormat::RGB32UI: result = 12;
      break;
    case ImageFormat::RGB32F: result = 12;
      break;
      // 4 channel
    case ImageFormat::BGRA8: result = 4;
      break;
    case ImageFormat::RGBA8: result = 4;
      break;
    case ImageFormat::RGBA16: result = 8;
      break;
    case ImageFormat::RGBA16F: result = 8;
      break;
    case ImageFormat::RGBA32UI: result = 16;
      break;
    case ImageFormat::RGBA32F: result = 16;
      break;
      // Depth/stencil
    case ImageFormat::D16: result = 0;
      break;
    case ImageFormat::X8D24PAX32: result = 0;
      break;
    case ImageFormat::D32F: result = 0;
      break;
    case ImageFormat::S8: result = 0;
      break;
    case ImageFormat::D16S8: result = 0;
      break;
    case ImageFormat::D24S8: result = 0;
      break;
    case ImageFormat::D32S8: result = 0;
      break;
    default: break;
  }
  return result;
