...
#ifndef TINYFORMAT_IMPLEMENTATION_FILE
#define TINYFORMAT_IMPLEMENTATION_FILE 1
#endif

#if defined(TINYFORMAT_IMPLEMENTATION_FILE) && TINYFORMAT_IMPLEMENTATION_FILE == 1
//------------------------------------------------------------------------------
...
//  std::showpos is broken on old libstdc++ as provided with OS_OSX.  See
//  http://gcc.gnu.org/ml/libstdc++/2007-11/msg00075.html
#   define TINYFORMAT_OLD_LIBSTDCPLUSPLUS_WORKAROUND
#endif

#ifdef __APPLE__
// Workaround OS_OSX linker warning: xcode uses different default symbol
...
#if defined(TINYFORMAT_IMPLEMENTATION_FILE) && TINYFORMAT_IMPLEMENTATION_FILE == 0
#define TINYFORMAT_DEFINE_FORMAT_TRUNCATED_CSTR(type)       \
void formatTruncated(std::ostream& out, type* value, int ntrunc);
#else
#define TINYFORMAT_DEFINE_FORMAT_TRUNCATED_CSTR(type)       \
