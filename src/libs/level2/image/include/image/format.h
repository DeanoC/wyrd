#if !defined( WYRD_IMAGE_FORMAT_H_ ) || defined( IF_START_MACRO )

#if !defined IF_START_MACRO

#define WYRD_IMAGE_FORMAT_H_ 1
#define IF_START_MACRO typedef enum Image_Format {
...
#if !defined IF_MOD_MACRO
#define IF_MOD_MACRO(x) Image_Format_##x,
#endif

#if !defined IF_END_MACRO
#define IF_END_MACRO } Image_Format;
#endif
